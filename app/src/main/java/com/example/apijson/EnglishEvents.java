...
public class EnglishEvents extends AppCompatActivity {
   ...
   // private RecyclerView.LayoutManager mLayoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_events);
    ...
    String url ="https://event.kku.edu.sa/ws/events-en.json";
            ...
            new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        //mLayoutManager = new LinearLayoutManager(EnglishEvents.this);
                     //   recyclerView.setLayoutManager(mLayoutManager);
                        adapterItems = new Adapter(EnglishEvents.this, addItems1);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.arabic){
            ...
            Intent intent = new Intent(EnglishEvents.this,MainActivity.class);
